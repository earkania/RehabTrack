...
/// Attachments section for the Doctor Prescription form
class PrescriptionAttachmentsSection extends ConsumerStatefulWidget {
  final List<File> newAttachments;
  final List<DoctorPrescriptionAttachment> existingAttachments;
  final VoidCallback onAddPdf;
  final VoidCallback onAddImage;
  final VoidCallback onTakePhoto;
  final void Function(int) onRemoveAttachment;

  const PrescriptionAttachmentsSection({
    super.key,
  ...
  @override
  ConsumerState<PrescriptionAttachmentsSection>
      createState() => _PrescriptionAttachmentsSectionState();
}

class _PrescriptionAttachmentsSectionState
    extends ConsumerState<PrescriptionAttachmentsSection> {
  @override
              ...
              return _NewAttachmentTile(
                ...
                onRemove: () {
                  widget.onRemoveAttachment(
                    widget.existingAttachments.length + index,
                  );
                },
              );
            },
